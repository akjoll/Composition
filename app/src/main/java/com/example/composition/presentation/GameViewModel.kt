...
import com.example.composition.domain.usecases.GenerateQuestionUC
import com.example.composition.domain.usecases.GetGameSettingsUC
...
class GameViewModel(
    ...
    private val generateQuestionUC = GenerateQuestionUC(repository)
    private val getGameSettingsUC = GetGameSettingsUC(repository)
    ...
    private fun getGameSettings() {
        gameSettings = getGameSettingsUC(level)
    ...
    private fun generateQuestion() {
        _question.value = generateQuestionUC(gameSettings.maxSumValue)
    }
